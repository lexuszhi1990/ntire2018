...
for dataset:
  python test.py --gpu_id=4 --channel=1 --scale=4 --model=./models/lapsrn/lapsrn-epoch-100-step-180-2017-06-15-18-19.ckpt-180 --image=./dataset/test/set5/mat --output_dir=./dataset/test/set5/lapsrn/test
'''
