...
input_dir = '/home/mcc207/workplace/repos/ntire2018/dataset'
...
def compute_measures(ref_im, res_im):
    return output_measures(
        ...
        _open_img_measures(os.path.join(input_dir,'DIV2K_valid_HR_difficult_RES',res_im))
        )
...
res_dir = os.path.join(input_dir, 'DIV2K_valid_HR_difficult_RES/')
