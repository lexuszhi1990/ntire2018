...
for dataset:
  python test_ml.py --gpu_id=3 --channel=1 --scale=4 --model=./ckpt/lapsrn/lapsrn-epoch-100-step-36-2017-06-14-15-42.ckpt-36 --image=./dataset/test/set5/mat --output_dir=./dataset/test/set5/lapsrn/test
'''
